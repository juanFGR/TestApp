...
window.globalVariable = {
    ...
    oAuth: {
        dropbox: "eq6yjihajbsu2dj",//Use for Dropbox API clientID.
        linkedin: "77qiftwdu70qpj",
        facebook: "1713235985555780",//Use for Facebook API appID.
        foursquare: "FOZI3BZCS0BFZUEK52D0XZ1PCSFWABKGGICCM51I5WECMDJ5", //Use for Foursquare API clientID.
        instagram: "6096fa747901477eb07ad5189e859b61",//Use for Instagram API clientID.
        googlePlus: "608291373707-mr7c6lijjr9suvpoqgsb3pk63gsenj1c.apps.googleusercontent.com",//Use for Google API clientID.
    },
...
angular.module('starter', ['ionic','ngIOS9UIWebViewPatch', 'starter.controllers', 'starter.services', 'ngMaterial', 'ngMessages', 'ngCordova'])
    .run(function ($ionicPlatform, $cordovaSQLite, $rootScope, $timeout, $cordovaSocialSharing, $ionicHistory, $state, $mdDialog, $mdBottomSheet) {
        ...
        $rootScope.navigateTo = function (targetPage) {
                $state.go(targetPage);
        };

          $rootScope.shareTwitter = function(uri) {
                    $cordovaSocialSharing
                        .shareViaTwitter('Interesante #consejodocardy', uri, 'www.docardy.com')
          ...
          $rootScope.shareFacebook = function(uri) {
                 $cordovaSocialSharing
                    .shareViaFacebook('Interesante #consejodocardy', uri, 'www.docardy.com')
                    .then(function(result) {
                      // Success!
                    }, function(err) {
                      // An error occurred. Show a message to the user
          ...
          $rootScope.shareWhatsapp = function(uri) {
                   $cordovaSocialSharing
                    .shareViaWhatsApp('Interesante #consejodocardy', uri, 'www.docardy.com')
                    .then(function(result) {
                      // Success!
                    }, function(err) {
                      // An error occurred. Show a message to the user
    ...
    .config(function ($ionicConfigProvider, $stateProvider, $urlRouterProvider, $mdThemingProvider, $mdIconProvider, $mdColorPalette, $mdIconProvider) {
        ...
        $stateProvider
            ...
            .state('app.eventdetail', {
                ...
                views: {
                    '/eventdetail': {
                        templateUrl: "templates/themes/news-feed/html/event-detail.html",
                        controller: "feedCtrl"
                    }
                }
            })
            ...
            .state('app.card', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/cards/html/cards.html"
                    }
                }
            })
            .state('app.contact', {
