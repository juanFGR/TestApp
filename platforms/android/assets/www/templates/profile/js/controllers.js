...
appControllers.controller('profileCtrl', function ($scope, $rootScope, $cordovaSocialSharing, $cordovaSms, svprofile) {


$scope.genders = ('Masculino Femenino').split(' ').map(function(state) {
        return {option: state};
      });
    ...
    $scope.save = function () {
        svprofile.save($scope.profile).then(function(data) { });
    };
